...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/csoe-hub/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/csoe-hub/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/csoe-hub/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/csoe-hub/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/csoe-hub/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/csoe-hub/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 17m48.528s                | 1m38.290s                 | 
| `pg_normalized_batch`  | 3m23.826s                 | 0m0.578s                  | 
| `pg_denormalized`      | 0m15.837s                 | 0m3.955s                  | 
