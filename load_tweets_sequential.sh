...
time for file in $files; do
    echo
    python3 -u load_tweets.py --db=postgresql://postgres:pass@localhost:15440/postgres --inputs $file
done
...
echo '================================================================================'
time for file in $files; do
    python3 -u load_tweets_batch.py --db=postgresql://postgres:pass@localhost:15441/postgres --inputs $file
done
